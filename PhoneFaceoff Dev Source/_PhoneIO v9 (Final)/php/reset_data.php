<?php
	/**
	 * Deletes then inserts data into the phonedata table.
	 * File can be executed whenever data inside the phonedata table is deleted or obsolete 
	 * to re-insert the correct data
	 *
	 * @author Philip Scott
	 * @date 2016-05-22
	 */
	 ...
	 *				$msg			string that indicates the type of action performed for debugging purposes
	...
	// Note: "outOfTen" is modified so that all fields are empty the empty fields load
	...
	$sql = "INSERT INTO phonedata (
			...
			'LTE band 1(2100), 3(1800), 7(2600), 8(900), 20(800) - XT1644<br>LTE band 1(2100), 2(1900), 3(1800), 4(1700/2100), 5(850), 7(2600), 8(900), 12(700), 13(700), 25(1900), 26(850), 41(2500) - XT1644 (USA)<br>LTE band 1(2100), 3(1800), 5(850), 8(900), 40(2300) - XT1644 (India)',
			'HSPA 42.2/5.76 Mbps, LTE Cat4 150/50 Mbps',
			'Yes',
			'Yes',
			'2016, May',
